...
SCHEMA="datatime:TIMESTAMP,carrier_name:STRING,client:STRING,client_type:STRING,customer_name:STRING,endpoint:STRING,attribute:STRING,pricing_type:STRING,transaction_type:STRING,transaction_type_count:INT64,total_full_rate_billable_transaction:INT64,total_lower_rate_billable_transaction:INT64,total_no_billable_transaction:INT64,avg_latency_full_rate:FLOAT64,avg_latency_lower_rate:FLOAT64,avg_latency_no_billable:FLOAT64,unit_price:FLOAT64,markup_percentage:FLOAT64,discount_price:FLOAT64,est_revenue:FLOAT64"
